 ...
 * than rely on every pattern being perfect forever, every regex that touches fetched content
 * reads it through this class: the engine calls [get] for each character it examines, so however
 * bad the pattern, the work stops with [CloneException.Unreachable] once the budget is spent.
 *
