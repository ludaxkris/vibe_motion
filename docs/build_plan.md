...
| Next.js | Next.js 15, App Router, TypeScript, Tailwind, shadcn/ui, Node 22 | Pages Router, Vite SPA | App Router is the current default. The preview page and help page are mostly client components. |
